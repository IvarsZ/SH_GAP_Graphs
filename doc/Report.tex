...
TODO dense, sparse graphs, depth
...
TODO The BFS/DFS "extended" for all vertices to standardize. Connected for parallel due same reasons, could really extend to make them comparable at least not easily.

TODO - WHY BFPS diff impl. tested for multiple cores.

TODO - GRAPHS, complexity matches practical results, what happened with MST.
...
\includegraphics[width=\textwidth]{../experiments/plots/SCC_time}

\includegraphics[width=\textwidth]{../experiments/plots/SCC_components}

\includegraphics[width=\textwidth]{../experiments/plots/MST_time}

\includegraphics[width=\textwidth]{../experiments/plots/MST_weight}

\includegraphics[width=\textwidth]{../experiments/plots/SP_time}

\includegraphics[width=\textwidth]{../experiments/plots/MC_time}

\includegraphics[width=\textwidth]{../experiments/plots/MC_colors}
